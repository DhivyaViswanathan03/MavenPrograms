...
public class WishServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (hour < 12)
			...
			pw.println("<h2 style='color:blue;text-align:center;' ><center>Good Evening</center></h2>");
		else
			pw.println("<h2 style='color:blue; text-align:center;'><center>Good night</center></h2>");
